"""
Django settings for bjwenlian_rest project.
...
ROOT_URLCONF = 'bjwenlian_rest.urls'
...
WSGI_APPLICATION = 'bjwenlian_rest.wsgi.application'
...
JWT_AUTH = {
    ...
    'JWT_AUTH_HEADER_PREFIX': 'AUTHTOKEN',
}
